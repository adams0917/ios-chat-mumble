...
@interface MumblerUser : NSManagedObject

@property (nonatomic, retain) NSString * adjusted_chat_opened_time;

@property (nonatomic, retain) NSString * alias;
@property (nonatomic, retain) NSString * chatTimeLimit;
...
@property (nonatomic, retain) NSString * saveOutGoingMedia;
@property (nonatomic, retain) NSString * section_text;
