...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Color Declarations
    UIColor* gradientColor = [UIColor colorWithRed: 43/255 green: 193 blue: 255 alpha: 1];
    UIColor* gradientColor2 = [UIColor colorWithRed: 43/255 green: 193 blue: 255 alpha: 1];
    UIColor* shadowColor2 = [UIColor colorWithRed: 43/255 green: 200 blue: 218 alpha: 1];
